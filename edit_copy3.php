...
<body>
	<form name="inputptspkn" method="post" action="edit_copy3.php">
		<table>
			<tr>
				<th>No.</th>
				<th>NISN</th>
			...
			<tr>
				<td>
					<input readonly name="no_ptspkn[]" type="text" id="no_ptspkn" value="<?php echo $rows['no_ptspkn']; ?>">
				</td>
				<td>
					<input disabled name="nisn_siswa[]" type="text" id="nisn_siswa" value="<?php echo $rows['nisn_siswa']; ?>">
				</td>
				<td>
					<input disabled name="nama_siswa[]" type="text" id="nama_siswa" value="<?php echo $rows['nama_siswa']; ?>">
				</td>
				<td>
					<input name="nilai_ptspkn[]" type="text" id="nilai_ptspkn" value="<?php echo $rows['nilai_ptspkn']; ?>">
				</td>
			</tr>
			<?php } ?>
			<tr>
...
header("Location: edit_copy3.php");
}
}
echo $count;
mysqli_close($mysqli);
